            ...
            <div className="footer__bg bg-secondary pt-8 px-0 pb-12 dark:bg-secondary-dark md:pt-12 md:px-0 md:pb-14">
                <div className="footer__container container grid gap-6 gap-y-14 xs:mx-4 sm:grid-cols-[repeat(2,_1fr)] md:mx-auto md:py-0 md:px-4 md:grid-cols-[repeat(3,_1fr)] lg:p-0">
                    ...
                    <div className="footer__socials flex text-white md:justify-self-end">
                        ...
                        <a href="https://twitter.com/idkandev" target="_blank" rel="noopener noreferrer" className="footer__socials-item text-sm mr-6 hover:text-primary-light">
                            <FiTwitter className="inline-block" />
                        </a>
                        <a href="https://www.instagram.com/idkan.dev/" target="_blank" rel="noopener noreferrer" className="footer__socials-item text-sm mr-6 hover:text-primary-light">
                            <FiInstagram className="inline-block" />
                        </a>
                    </div>
                </div>
                <p className="footer__copyright text-xs text-center text-primary-light mt-12 md:mt-[4.5rem]"> &copy; 2022 Idkan Dev. All rights reserved. </p>
            </div>
        </footer>
    );
}

				...
				<div className="max-w-5xl mx-auto grip gap-4">
					<div className="grid grid-cols-home-content pt-14 items-center mb-4">
						...
						<div className="home__data">
							...
							<p className="text-base mb-2">I'm a full stack developer with a passion for building web applications. I have a strong background in web development and have worked with a wide range of technologies.</p>
							<a href="#contact" className="flex items-center text-secondary">Let's talk <FiSend className="ml-1" /></a>
						</div>
					</div>
					<div className="home__scroll text-secondary">
